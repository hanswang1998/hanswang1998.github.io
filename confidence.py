...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\why\\Desktop\\动态决策测验psychopy\\confidence.py',
...
image = visual.ImageStim(
    win=win,
    name='image', 
    image='元认知指导语1.jpg', mask=None, anchor='center',
...
image_2 = visual.ImageStim(
    win=win,
    name='image_2', 
    image='元认知指导语2.jpg', mask=None, anchor='center',
    ori=0.0, pos=(0, 0), size=(1.92, 1.08),
    color=[1,1,1], colorSpace='rgb', opacity=None,
    flipHoriz=False, flipVert=False,
    texRes=128.0, interpolate=True, depth=0.0)
...
image_3 = visual.ImageStim(
    win=win,
    name='image_3', 
    image='元认知指导语3.png', mask=None, anchor='center',
    ori=0.0, pos=(0, 0), size=(1.92, 1.08),
    color=[1,1,1], colorSpace='rgb', opacity=None,
    flipHoriz=False, flipVert=False,
...
, log=False)
        ...
        ###时间显示模块
        showtime,timecoder= getdowntime(600)
        ###动效价值条块
    ...
    taskresultA=random.randrange(65,75,1)
    taskresultB=random.randrange(75,85,1)
    taskresultC=random.randrange(85,95,1)
    ...
    #showresult1.setText(
    #    f"""
    #    您选择执行的任务是：任务{tasknumber};
    #
    #    您本轮任务的评分是：{taskresultA};
    #
    #    您所获得的积分是：{round(taskresultA,1)}X{VAR1/100}={round(taskresultA*VAR1/100,1)}
    #    """)
    #showresult1.setText(
    #    f"""您选择执行的任务是：任务{tasknumber};
    #
    #    您本轮任务的评分是：{taskresultB}  ;
    #
    #    您所获得的积分是：{round(taskresultB,1)}X{VAR2/100}={round(taskresultB*VAR2/100,1)}""")
    #showresult1.setText(
    #    f"""您选择执行的任务是：任务{tasknumber};
    #
    #    您本轮任务的评分是：{taskresultC}  ;
    #
    #    您所获得的积分是：{round(taskresultC,1)}X{VAR3/100}={round(taskresultC*VAR3/100,1)}""")
