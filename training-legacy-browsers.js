...
function setpRoutineBegin(snapshot) {
  return async function () {
    ...
    setpComponents.forEach( function(thisComponent) {
...
function training_introRoutineBegin(snapshot) {
  return async function () {
    ...
    training_introComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function model_pattern_introRoutineBegin(snapshot) {
  return async function () {
    ...
    model_pattern_introComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function model_patternRoutineBegin(snapshot) {
  return async function () {
    ...
    model_patternComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function mpfeedbackRoutineBegin(snapshot) {
  return async function () {
    ...
    mpfeedbackComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function feedback_ARoutineBegin(snapshot) {
  return async function () {
    ...
    feedback_AComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function two_back_introRoutineBegin(snapshot) {
  return async function () {
    ...
    two_back_introComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function n_backRoutineBegin(snapshot) {
  return async function () {
    ...
    n_backComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function n_backfeedbackRoutineBegin(snapshot) {
  return async function () {
    ...
    n_backfeedbackComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function feedback_BRoutineBegin(snapshot) {
  return async function () {
    ...
    feedback_BComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function vsintroRoutineBegin(snapshot) {
  return async function () {
    ...
    vsintroComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function vsfeedbackRoutineBegin(snapshot) {
  return async function () {
    ...
    vsfeedbackComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function tackcnum_addRoutineBegin(snapshot) {
  return async function () {
    ...
    tackcnum_addComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
